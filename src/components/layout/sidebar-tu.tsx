...
const menuItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Singkron DAPODIK', href: '/tu/singkron-dapodik', icon: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15' },
      ...
      { label: 'Organisasi', href: '/tu/organisasi', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
  ...
  },
  {
    ...
    items: [
      { label: 'Laporan Pendidikan', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', children: [
        ...
        { label: 'Daftar Kumpulan Nilai', href: '/tu/laporan-pendidikan/daftar-kumpulan-nilai' },
      ] },
      ...
      { label: 'Kokurikuler', href: '/tu/kokurikuler', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
      ...
      { label: 'Integrasi & Panduan API', href: '/tu/integrasi-api', icon: 'M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
