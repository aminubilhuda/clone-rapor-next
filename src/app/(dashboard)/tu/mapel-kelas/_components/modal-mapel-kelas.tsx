          ...
          <div className="px-6 py-4 space-y-4">
            <div>
              ...
              {autoKelas ? (
                ...
                <select name="id_kelas" defaultValue={mapelKelas?.id_kelas ?? ''} required className="w-full bg-[#F8F9FB] border border-[rgba(0,0,0,0.08)] rounded-xl px-3.5 py-2.5 text-sm focus:ring-2 focus:ring-red-500/20 focus:border-[#DC2626] outline-none transition-all">
            ...
            <div>
              <label className="block text-sm font-medium text-[#1A1A2E]/80 mb-1.5">Mata Pelajaran {!isEdit && <span className="text-gray-400 font-normal">(bisa pilih banyak)</span>}</label>
              {isEdit ? (
                <select name="id_mapel" defaultValue={mapelKelas?.id_mapel ?? ''} required className="w-full bg-[#F8F9FB] border border-[rgba(0,0,0,0.08)] rounded-xl px-3.5 py-2.5 text-sm focus:ring-2 focus:ring-red-500/20 focus:border-[#DC2626] outline-none transition-all">
                ...
                <>
                  <input
                    ...
                    className="w-full bg-[#F8F9FB] border border-[rgba(0,0,0,0.08)] rounded-xl px-3.5 py-2.5 text-sm focus:ring-2 focus:ring-red-500/20 focus:border-[#DC2626] outline-none transition-all mb-2"
                  />
