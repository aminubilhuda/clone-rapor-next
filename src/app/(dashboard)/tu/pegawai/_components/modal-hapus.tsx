...
export default function ModalHapus({ open, onClose, pegawai, onConfirm }: ModalHapusProps) {
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 animate-modal-in">
        ...
        <div className="px-6 py-4">
          <div className="flex items-center gap-3 text-yellow-700 bg-yellow-50 rounded-lg p-3 mb-3 text-sm">
            ...
            <span>Data yang dihapus akan disembunyikan dan tidak bisa digunakan kembali.</span>
          </div>
          <p className="text-gray-700 text-sm">
            Apakah kamu yakin ingin menghapus <strong>{pegawai.nama}</strong>?
          </p>
        </div>
