        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="px-6 py-4 space-y-4">
            <div>
              ...
              <input name="nama_eskul" defaultValue={ekstra?.nama_eskul ?? ''} required className="w-full border rounded px-3 py-2 text-sm" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Kode</label>
              <input name="kode" defaultValue={ekstra?.kode ?? ''} required className="w-full border rounded px-3 py-2 text-sm" />
            </div>
          </div>
